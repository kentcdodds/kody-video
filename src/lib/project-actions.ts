...
export async function appendRecording(
  ...
  if (options?.capturedThumbs) {
    ...
    clip.thumbs = options.capturedThumbs.thumbs
    clip.poster = options.capturedThumbs.poster
    clip.thumbWidth = options.capturedThumbs.thumbWidth
    clip.thumbHeight = options.capturedThumbs.thumbHeight
  }
