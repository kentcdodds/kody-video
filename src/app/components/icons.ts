...
function svg(size: number, inner: string): SVGSVGElement {
  return fromHtml<SVGSVGElement>(
...
export const iconFlip = (size = 22) =>
  svg(
    size,
    '<path d="M16 4l3 3-3 3"/><path d="M4 11V9a4 4 0 014-4h11"/>' +
      '<path d="M8 20l-3-3 3-3"/><path d="M20 13v2a4 4 0 01-4 4H5"/>',
  )

export const iconTorch = (size = 22, on = false) =>
  svg(size, `<path d="M13 3L7 13h5l-1 8 6-10h-5l1-8z" fill="${on ? 'currentColor' : 'none'}"/>`)

export const iconTimer = (size = 22) =>
  svg(
    size,
    '<circle cx="12" cy="13" r="7"/><path d="M12 10v3.5l2 1.2"/>' +
      '<path d="M9 3.5h6"/><path d="M12 3.5V5"/>',
  )

/** Map-pin outline for location tagging. */
export const iconLocation = (size = 22) =>
  svg(
    size,
...
export const iconEditor = (size = 22) =>
  svg(
    size,
    '<circle cx="6.5" cy="6.5" r="2.25"/><circle cx="6.5" cy="17.5" r="2.25"/>' +
...
export const iconDeleteLast = (size = 22) =>
  svg(
    size,
...
export const iconTrash = (size = 22) =>
  svg(
    size,
    '<path d="M5 7h14"/><path d="M9 7V5.5A1.5 1.5 0 0110.5 4h3A1.5 1.5 0 0115 5.5V7"/>' +
      '<path d="M8 7l.7 11.2A1.5 1.5 0 0010.2 19.5h3.6a1.5 1.5 0 001.5-1.3L16 7"/>' +
      '<path d="M10.5 11v5"/><path d="M13.5 11v5"/>',
  )

export const iconDuplicate = (size = 22) =>
  svg(
    size,
...
export const iconTrim = (size = 22) =>
  svg(
    size,
    '<path d="M5 6v12"/><path d="M3.5 6h3"/><path d="M3.5 18h3"/>' +
...
export const iconUndo = (size = 22) =>
  svg(size, '<path d="M7 5L4 8l3 3"/><path d="M4 8h7a5 5 0 110 10H9"/>')

/** The iOS share glyph: box with an arrow rising out of it. */
export const iconShareIos = (size = 22) =>
  svg(
    size,
...
export const iconLens = (size = 22) =>
  svg(size, '<circle cx="12" cy="12" r="8.5"/><circle cx="12" cy="12" r="3.5"/>')

export const iconLock = (size = 22) =>
  svg(
    size,
    '<rect x="5" y="10.5" width="14" height="9.5" rx="2"/><path d="M8 10.5V7.5a4 4 0 018 0v3"/>',
  )

/** Monitor with a record dot: screen recording. */
export const iconScreen = (size = 22, on = false) =>
  svg(
    size,
    '<rect x="3" y="4.5" width="18" height="12.5" rx="2"/><path d="M9 20.5h6"/>' +
