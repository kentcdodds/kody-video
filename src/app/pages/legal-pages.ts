...
function legalScreen(title: string, bodyHtml: string): HTMLElement {
  return h(
    'div',
...
export class KvPrivacyPage extends KvElement<void> {
...
export class KvTermsPage extends KvElement<void> {
  override render(): void {
    this.replaceChildren(
      legalScreen(
        'Terms',
