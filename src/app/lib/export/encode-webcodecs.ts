...
import { deriveProjectLocation } from '../geo.ts'
import { isIosBrowser } from '../media.ts'
import type { ClipRecord } from '../types.ts'
import { injectMp4Metadata, type Mp4Chapter } from './mp4-metadata.ts'
import { createOpfsExportFile } from './opfs.ts'
import { clampSegmentToMedia, type ExportPlan } from './plan.ts'
import {
  PREVIEW_INTERVAL_MS,
  blitPreview,
  decodeClipAudio,
