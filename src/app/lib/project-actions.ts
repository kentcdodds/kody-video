...
import { estimateExportCacheBytes } from './export/export-cache.ts'
import { estimateStorageSpace, type StorageSpace } from './storage-space.ts'
import { ensureClipThumbs, type GeneratedThumbs } from './thumbs.ts'
import {
  NEW_PROJECT_ID,
  effectiveDurationMs,
  type ClipId,
