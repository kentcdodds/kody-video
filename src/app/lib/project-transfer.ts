import { addClip, createProject, deleteProject, updateClipTrim } from './storage.ts'
import { ensureClipThumbs } from './thumbs.ts'
import type { ClipRecord, Project } from './types.ts'
