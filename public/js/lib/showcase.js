/**
 * This branch is the vanilla web-components edition of Kody Video, kept
 * online as a showcase (vanilla.kody.video). Every deployment of it should
 * point visitors at the real app and at the PR where the agent analyzed the
 * experiment, so the banner shows on any non-local hostname.
 */

export const SHOWCASE_EDITION = 'vanilla web-components edition'
export const SHOWCASE_PR_URL = 'https://github.com/kentcdodds/kody-video/pull/88'
export const SHOWCASE_PR_NUMBER = 88
