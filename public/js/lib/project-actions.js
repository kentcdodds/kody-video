...
export async function loadProjectPage(projectId) {
    try {
...
export async function appendRecording(projectId, input, options) {
...
export async function undoLastDelete(projectId) {
    return undoDeleteLastClip(projectId);
}
export async function duplicateSelectedClip(clipId) {
    return duplicateClip(clipId);
}
export async function moveSelectedClip(projectId, clipId, direction) {
    await moveClip(projectId, clipId, direction);
}
export async function trimClip(clipId, trimStartMs, trimEndMs) {
