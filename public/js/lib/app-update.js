...
export function registerUpdateHandles(reg, apply) {
...
export async function checkForUpdates() {
    ...
    const workerAppeared = Boolean(reg.installing || reg.waiting) ||
...
async function applyAndReload(apply) {
    try {
        await apply(true);
    }
    catch {
